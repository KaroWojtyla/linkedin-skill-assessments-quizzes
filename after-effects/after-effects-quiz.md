...
- [x] Command+click (Mac) or Ctrl+click (Windows) a property in the Timeline to add it to the Essential Graphics panel.
...
- [x] All properties are supported by the Essential Graphics panel.
